/**
 * Logo reale fornito dall'utente (mercedes-benz-logo.svg), non un
 * ridisegno: qui va usato cosi' com'e', solo ridimensionato. Incorporato
 * come stringa perche' Metro non ha un loader per importare file .svg
 * come testo di default.
 *
 * Un solo ritocco strutturale (non artistico): il file originale
 * racchiude il disegno in <switch><foreignObject .../><g>...</g></switch>,
 * un fallback per Illustrator che react-native-svg non sa interpretare —
 * lo trattava come "niente da disegnare" e il logo spariva. Tolto lo
 * switch/foreignObject e spostato il loro transform sul <g> rimasto, che
 * e' l'unico ramo che veniva mai mostrato in un browser vero.
 */
export const MERCEDES_LOGO_SVG = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<svg
   ...
   inkscape:export-ydpi="561.73999"><metadata
     ...
     inkscape:current-layer="mb-stern_x5F_10" /><g transform="matrix(8.0268736,0,0,8.0268736,93.140045,93.140045)"><g
       i:extraneous="self"
